...
function displayCategories(arr) {
    let cartona = ``
    for (let i = 0; i < arr.length; i++) {
        cartona += ` <div class="col-md-3 py-4">
...
function displayArea(arr) {
    let cartona = ``;
    for (let i = 0; i < arr.length; i++) {
        cartona += ` <div class="col-md-3 py-4" onclick="getAreaMeals('${arr[i].strArea}')">
...
function displayIngredients(arr) {
    let cartona = ``
    for (let i = 0; i < arr.length; i++) {
        cartona += `<div class="col-md-3 py-4" onclick="getIngredientMeals('${arr[i].strIngredient}')">
                <figure class="card custom text-center text-white background">
